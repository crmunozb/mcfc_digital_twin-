...
entrenar_pls_cv.py
------------------
Entrena un modelo PLS sobre el dataset MCFC usando una
validación metodológicamente robusta:
...
Uso:
    python3 entrenar_pls_cv.py --fuente warsaw_ut
    python3 entrenar_pls_cv.py --fuente warsaw_ut sintetico
    python3 entrenar_pls_cv.py --fuente sintetico
"""
...
# ── Argumento fuente ──────────────────────────────────────────────────────────
parser = argparse.ArgumentParser(description="Entrenamiento PLS para celda MCFC")
parser.add_argument(
    '--fuente', nargs='+',
